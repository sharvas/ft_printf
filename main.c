...
/*   Updated: 2018/12/12 11:57:25 by svaskeli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	ft_printf("ft.%Lf\n", i);
//	ft_printf("ft.%f\n", j);
	printf("rl.%5.15Lf test2 %10.6Lf test3 %.Lf test 4%% %.5d i: %.5i str: %.50s\n", i, i, i, -2, j, str);
	ft_printf("ft.%5.15Lf test2 %10.6Lf test3 %.Lf test 4%% %.5d i: %.5i str: %.50s\n", i, i, i, -2, j, str);
//	ft_printf("ft.%20p\n test2 %20p\n test3 %lli\n test 4%%\n\n", n, n, a);
}
